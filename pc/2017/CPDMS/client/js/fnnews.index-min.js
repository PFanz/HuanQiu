! function(e) {
  ...
  function t(e, a, t) { M.attr("src", ""), M.contents().find("body").html("<div style='text-align:center; margin-top: 10px;' class='fn-s-indexLoad'><img src='/images/ajax-loader.gif'/></div>"), P.init(e, a), M.attr("src", "/api/index.php?c=content&id=" + t + "&keypar=") }
  ...
  function i() {
    fnTool.ajaxSimply("get", {}, "/api/index.php?c=lists&catid=138&thumb=1&limit=6", function(a) {
  ...
  function o(a, t) {
    var n = new Date,
      ...
      o = {};
    fnTool.ajaxSimply("get", o, "/api/index.php?c=lists&a=media&catid=1259&limit=6", function(a) {
      function t(a) {
        ...
        var p = '{#list}<li class="fn-s-hotList" data-aid="{articlesequenceid}">{#if (picUrl)}<div class="fn-s-mfTop fn-clearfix">{#else}<div class="fn-s-mfTop fn-s-mfNTop fn-clearfix">{#/if}<div class="fn-s-mfLeft fn-fl"><h4>{title}</h4><p class="fn-s-hotNum"><div class="fn-x-hotStatisticsLine" data-id="{articlesequenceid}" data-ut="{ut}"><div style="position: relative;" data-toggle="tooltip" data-placement="bottom" title="点击这里您还能看到曲线图哦"><font class="fn-x-bar-label fn-text-weibo">{samecount}</font></div></div></p></div>{#if (picUrl)}<div class="fn-s-mfRight fn-fr" style="background-image:url({picUrl}); background-size: cover; background-repeat: no-repeat;"></div>{#/if}</div><p class="fn-s-mfKeyTag fn-clearfix" title="关键字"><label class="fn-s-mfKey fn-fl">关键字：<span>{keyWords}</span></label><b class="fn-s-mfTag fn-fr">{class1}</b></p><div class="fn-s-time fn-clearfix"><div class="fn-fl"><span class="fa fa-clock-o"></span><span>{utAB}</span></div><span class="fn-fr">{#if (collect == 1)}<span data-id="{articlesequenceid}" class="fa fa-star fn-s-collection"></span>{#else}<span data-id="{articlesequenceid}" class="fa fa-star-o fn-s-collection" style="display: none;"></span>{#/if}</div></li>{#/list}',
  ...
  function r(a, t, n, s) {
    function i(i, l) {
      var url = ''
      if (a === 12839) {
        url = '/api/index.php?c=lists&a=toutiao&catid=127&thumb=1'
      } else if (a === '7259') {
        url = '/api/index.php?c=lists&a=place&catid=86&limit=6'
      } else {
        url = k
      }
      fnTool.ajaxSimply("get", {}, url, function(a) {
        fnTool.handleViewData(a, function(a) {
          var i = a.rows,
            l = i.length,
            o = null,
  ...
  function p(a, t) {
    ...
    e(".fn-s-tCtl").hide(), fnTool.ajaxSimply("get", {}, '/api/index.php?c=position&a=follow', function(s) {
      n.css("background", "#fff");
      var i = '{#list}<li data-id="{id}" class="fn-s-traceList"><a target="_blank" href="/eventhome.html?cid={id}"><h4 class="fn-s-tHead" title="{text}">{text}</h4><blockquote>{ItemType}</blockquote></a><p class="fn-s-tTime">生成时间：<span class="fn-s-tt">{createTime}</span></p></li>{#/list}',
        l = s.nav;
      if (l.length) {
        e(".fn-s-tCtl").show();
  ...
  function h(a, t) {
    function n(a) {
      // fnTool.ajaxSimply("get", { whatDo: "getHotFindArticle" }, "/api/hotfind", function(t) {
      fnTool.ajaxSimply("get", {}, '/api/index.php?c=hit&begin=' + (+new Date() - (24*60*60*60) + '').substr(0, 10) + '&limit=9', function(t) {
  ...
  function g(t) {
    ...
    fnTool.ajaxSimply("get", {}, '/api/index.php?c=block&a=hot', function(t) {
      fnTool.handleViewData(t, function(t) {
        var n = '{#list}<li class="fn-s-mtList"><a target="_blank" href="/normalSearchResult.html?{searchParam}"><div class="fn-s-mtTop"><h5><label>名称：</label><span>{categoryName}</span></h5><p><label>时间：</label><time>{st} - {et}</time></p></div><div class="fn-s-mtBot"><span title="总共数目">{totalNum}</span><span title="今日更新数目"><i class="fa fa-arrow-up"></i>{todayNum}</span></div></a></li>{#/list}',
  ...
  var U = 0;
  e(function() {
    e(".fn-ss-tab").sTab({ _class: "fn-s-active" }),
      i(),
      s(),
      l(),
      o(),
      ...
      p(),
      h(),
      e("body").delegate(".fn-s-refresh", "click", function() {
        var a = e(this),
          t = a.parent().parent();
      ...
      e("body").delegate(".fn-s-hlList", "click", function(a) {
        t(a, e(this), e(this).attr("data-aid"))
      }),
      e("body").delegate(".fn-s-hotList", "click", function(a) {
        t(a, e(this), e(this).attr("data-aid"))
      }),
      // e("body").delegate(".fn-x-hotStatisticsLine", "click", function(e) { y.showStatisticsLine(this, e) }), 
      e("body").delegate(".fn-s-found", "click", function(a) { fnTool.stopPropagation(a), c(a, e(this)) }),
      e("body").delegate(".fn-s-collection", "click", function(a) { fnTool.stopPropagation(a), f(e(this)) }),
      e("body").delegate(".fn-s-localList", "click", function(a) { t(a, e(this), e(this).attr("data-aid")) }),
      e("#fn-s-focusImg").delegate("li", "click", function(a) { t(a, e(this), e(this).attr("data-id")) }),
      e("body").click(function(a) { e(".fn-x-chart").remove() }), m(), g(), v(), b()
  })
}(jQuery);
