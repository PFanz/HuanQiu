...
function NormalSearchClickNew() {
  ...
  // i.length > 0 && (t = i.find("span:eq(0)").html(), 
  //   a = i.attr("data-cityid"), n = i.attr("data-provincename")), 
  // $(".fn-chooseresults li").each(function() {
  //   null != $(this).find("span").eq(0).html() && "" != $(this).find("span").eq(0).html() && (e += $(this).find("span").eq(0).html() + ",")
  // });
  var s = $("#normalSearchKey"),
    o = $(".normal_search_option").eq(0);
  if (s.is(":focus") || o.is(":visible"))
    if ("" != s.val().replace(/ /g, "") || 
          "" != $("#anyKey").val().replace(/ /g, "") || 
            "" != $("#exceptKey").val().replace(/ /g, "")) {
              var c = "";
              // c = $(".fn-s-nsArea").is(":visible") || o.is(":hidden") 
              c = true
              // ? "/normalSearchResult.html?normalSearchKey=" + encodeURIComponent(s.val().replace(/\+/g, "%2B")) + "&type=" + $('input[name="radio2"]:checked').val() + "&startDate=" + $(".fn-s-timeInput").eq(0).val() + "&endDate=" + $(".fn-s-timeInput").eq(1).val() 
              ? "/normalSearchResult.html?normalSearchKey=" + encodeURIComponent(s.val().replace(/\+/g, "%2B"))
              : "/advancedsearch.html#/result?normalSearchKey=" + encodeURIComponent(s.val().replace(/\+/g, "%2B")) + "&anyKey=" + encodeURIComponent($("#anyKey").val()) + "&exceptKey=" + encodeURIComponent($("#exceptKey").val()) + "&searchRange=" + $('input[name="radio"]:checked').val() + "&searchResultType=" + $('input[name="radio3"]:checked').val() + "&startDate=" + $(".fn-s-timeInput").eq(0).val() + "&endDate=" + $(".fn-s-timeInput").eq(1).val() + "&mediaNameList=" + encodeURIComponent(e) + "&original=" + $('input[name="radio4"]:checked').val() + "&emotion=" + $('input[name="radio5"]:checked').val() + "&haveImage=" + $('input[name="radio6"]:checked').val() + "&searchType=" + $('input[name="radio7"]:checked').val() + "&cityInfo=" + ("" != n ? encodeURIComponent(n + "-" + t + "-" + a) : "") + "&wordNumFilter=" + $('input[name="radio8"]:checked').val() + "&wordNumRangeStart=" + $('.fn-x-word-num-box:eq(0)').val() + "&wordNumRangeEnd=" + $('.fn-x-word-num-box:eq(1)').val(), window.location.href.indexOf("normalSearchResult") > 0 || window.location.href.indexOf("advancedsearch") > 0 
                  ? ($("#search-top").removeClass("GPLOIDFCK4C"), $(".normal_search_option").slideUp(100), window.location.href = c + "&rd=" + Math.random()) 
                  : window.open(c)
...
function ChannelNameSearch(e) {
  if (13 == e.keyCode) return "txt_searchchannel" == document.activeElement.id && ("" != $("#txt_searchchannel").val() ? $.when(SearchChannel()).done(function() {
    $("#txtkeyWords").val(""), SetChannelInfo($("#fntree a").eq(0).attr("title"), $("#fntree a").eq(0).attr("id").replace("cnode_", "")), $.when(InitNewsList($("#txt_cid").val(), "0", pageSize)).done(function() {
      GetNews($("#newslist a:eq(1)"), $("#newslist a:eq(1)").find("strong").eq(0).html(), $("#txt_nid").val()), $("#newslist a:eq(1)").addClass("active_gray")
    })
  }) : LoadData()), e.keyCode = 9, !1
}
...
function ToNormalSearch() {
  $(".fn-choosedmedia").css({
    opacity: "1",
    "pointer-events": "all"
  }), 
  $(".fn-mediablock-inputsearch").val(""), 
  $(".fn-choosedmedia").html(""), 
  $(".fn-chooseresults").css("width", "auto"), 
  $(".fn-mediablock").hide(), 
  $(".fn-z-searchareacontent").hide(), 
  $(".fn-chooseresults").html(""), 
  0 == $(".fn-chooseresults").siblings().length && 
    $(".fn-chooseresults").parent("div").append('<div class="fn-s-sdPlacer text-default fn-addmediabutton">点击选择媒体</div>'), 
  $(".fn-s-supsArea").hide(), 
  $(".fn-s-nsArea").show(), 
  $(".fn-s-goNSearch").hide(), 
  $(".fn-s-gosSearch").show()
...
function AddMediaNew(e) {
  var t = $(e),
    ...
    n = $("#fn-s-cm");
  a.parent("div").width();
  0 == !a.siblings().length && a.siblings().remove(), 0 == a.find("div").length && a.html(""), t.remove(), a.prepend('<li><div class="btn btn-default btn-xs"><span>' + t.children("a").html() + "</span>&nbsp;<span class='fn-s-dCm'>x</span></div></li>"), 9 == a.find("button").length && n.css({
    opacity: "0.4",
    "pointer-events": "none"
  })
}
...
function ReduceMediaNew(e) {
  var t = $(e),
    a = $("#fn-s-cr"),
    n = $("#fn-s-cm");
  1 == a.children("li").length && a.parent().append('<div class="fn-s-sdPlacer text-default fn-addmediabutton">点击选择媒体</div>'), t.parents().filter("li").remove(), n.css({
    "pointer-events": "all",
    opacity: "1"
  }), n.prepend('<li><a href="javascript:void(0)">' + t.siblings("span").html() + "</a></li>")
}

function ShowMediaBlock(e) {
  $(".fn-z-searchareacontent").hide(), $(e).toggle(), ".fn-result-mediablock" == e && (getAbsPoint(), $(".fn-tag-left").toggle())
}
...
function AllMediaResults() {
  ...
  if ("" != e) {
    for (var n = [], i = (t.width(), a), s = "/api/dataJson", o = "", c = s + "?whatDo=GetTotalMediaList&mediaName=" + e + "&original=" + $('input[name="radio4"]:checked').val(), r = 0; r < t.children("li").length; r++) n.push(t.children("li").eq(r).find("span").eq(0).html());
    10 == n.length && a.css({
      "pointer-events": "none",
      opacity: "0.4"
    }), ajaxrequest = $.getJSON(c, function(e) {
...
function checkNotice() {
  $("#fa-newNotice").is(":visible") && $("#fa-newNotice").hide()
}

function checkSearch() {
  $("#searchContainer .normal_search_option").is(":visible") && ($("#searchContainer .normal_search_option").hide(), $("#normalSearchKey").css("width", "250px"))
}
  ...
  if (t[2]) {
    ...
    switch (n.removeClass("fn-s-active"), a) {
      ...
      case "eventhome":
        ...
        break;
      case "newsreprinted":
        n.eq(5).addClass("fn-s-active");
        break;
      case "leader":
        n.eq(6).addClass("fn-s-active");
        break;
...
function Search() {
  ...
  _self = this, citytemp = '{#list}{#if (city)}<li class="fn-z-cityname"><a href="#" data-cityname={city} data-provincename={provincename} data-cityid={cityID}>{city}</a>{#else}{#if (name=="上海"||name=="北京"||name=="天津"||name=="重庆"||name=="澳门"||name=="香港")}<li class="municipalities" data-cityid={cityID} data-provinceid={provinces}  data-provincename={name}  data-cityname={name}>{#else}<li class="fn-z-provincename" data-provinceid={provinces} data-provincename={name}>{#/if}<a href="#" data-provincename={name}>{name}</a>{#/if}</li>{#/list}', this.init = function() {
    $(".AccordionPanel").on("click", ".fn-z-areachoosedcontent", function(e) {
      ...
      i.hide(), s.show(), $(".fn-z-cityname").remove(), ajaxrequest = $.getJSON("/api/datajson?whatDo=getCity&province=" + t, function(a) {
    ...
    }), n.on("click", ".fn-z-cityname,.municipalities", function() {
      t.is(":visible") && (t.hide(), a.show()), _self.addCity($(this))
    }), n.on("click", ".fn-z-returnprovince", function() {
      s.hide(), i.show()
    }), e.on("click", ".fn-z-reducecity", function() {
      _self.reduceCity($(this))
    }), n.on("click", ".fn-z-searchareamiss", function(e) {
      e.stopPropagation(), $(".fn-z-searchareacontent").hide()
    })
  }
}
var fnTool = FNKitTool.createNew(),
  ...
  Notice = {
    ...
    resetHeight: function() {
      this.$noticeCon.css("height", "auto")
    },
    tagReaded: function(e, t) {
      var a = {
          whatDo: "updateMessageFromUnreadToRead"
        },
        n = this;
      ...
      fnTool.ajaxSimply("get", a, this.url, function(a) {
        a.Succeed ? "all" === e ? (n.showAlertInnerDom("已经全部标记为已读"), n.$numcon.attr("data-num", 0).html("0").hide(), n.showNoDom(), n.$lists.html("")) : (n.showAlertInnerDom("已经标记为已读"), "a" === i.context.tagName.toLowerCase() && (i = i.parent()), i.animate({
          height: "20px"
        }, 300, function() {
          i.remove(), n.changeNum(1, !1), t && t()
        })) : alertCustom("error", a.Msg)
      })
    },
    getNews: function(e) {
      var t = this,
      ...
      t.getNewsSwitch && (r.lastRunTime = t.lastRunTime), fnTool.ajaxSimply("get", r, t.url, function(a) {
        ...
        if (!t.getNewsSwitch) {
          if (e) {
            ...
            if (p > m) {
              ...
              t.$numcon.attr("data-num", u), u > 99 ? t.$numcon.html("99+") : t.$numcon.html(u), t.closeFixedGetNews(), setTimeout(function() {
                t.fixedGetNews()
              }, p - m)
            }
          }
        ...
        if (!(l <= 0)) {
          ...
          if (v.play && v.play(), n.is(":visible")) {
            ...
            t.$alertTxt.html(l);
            var g = "";
            l > 3 ? (g = t.concatHtml(r.slice(0, 3)), g += '<li class="list-group-item">……</li>') : g = t.concatHtml(r), t.$alert.children("ul.list-group").html(g), t.$alert.show(), t.$noticeTrigger.addClass("active"), setTimeout(function() {
              t.closeAlert()
            }, 1e4)
          }
          t.changeNum(l, !0)
    ...
    closeAlert: function() {
      this.$noticeTrigger.removeClass("active"), this.$alert.hide()
    },
    fixedGetNews: function() {
      var e = this;
      e.closeFixedGetNews(), e.timeClear = setInterval(function() {
        e.getInitNum()
      }, e.timeInterval)
    },
    closeFixedGetNews: function() {
    ...
    showNoticeDetail: function(e, t) {
      var a = $(e),
        n = this.$noticeDetail,
        i = this;
      i.$noticeCon.is(":hidden") ? (i.$noticeCon.show(), i.$noNews.hide(), i.$unreadNews.hide(), i.$hasNews.show()) : a.parent("ul").parent().hide(), n.attr("data-dom", t), i.resetHeight(), n.find(".fn-newsLoading").remove(), n.show(), n.children(".fn-detailContent").hide(), n.append("<div class='fn-newsLoading text-muted text-center'>正在获取新闻详情，请稍后...</div>"), i.ajaxDetail && i.ajaxDetail.abort(), i.ajaxDetail = fnTool.ajaxSimply("get", {
        whatDo: "SearchNormalForArticleID",
        key: a.children(".fa-noticeRight").attr("data-id"),
        articleTime: a.find(".fn-noticeTime span:eq(1)").text()
      }, "/api/dataJson", function(s) {
    ...
    showDataPage: function(e, t, a) {
      e.css("display", "block"), t && t(a)
    },
    showHasDom: function() {
      this.$hasNews.show(), this.$noNews.hide()
    },
    ...
    showNoDom: function() {
      this.$noNews.show(), this.$hasNews.hide(), this.resetHeight()
    },
    showAlertInnerDom: function(e) {
      var t = this;
      this.$innerAlert.html(e).show(), setTimeout(function() {
        t.$innerAlert.html("").hide()
      }, 2e3)
    },
    ...
    showReadedNews: function(e) {
      ...
      n.html(""), n.siblings(".fn-newsLoading").remove(), a.$readedLists.append("<div class='fn-newsLoading text-muted text-center'>正在加载已读列表，请稍后</div>"), n.scrollTop(0), a.ajaxReadList && a.ajaxReadList.abort(), a.ajaxReadList = fnTool.ajaxSimply("get", {
        whatDo: "GetListOfReadMessageByUser",
        PageSize: 20,
        PageIndex: 1,
        msgtype: ""
      }, this.url, function(e) {
    ...
    closeDataPage: function(e, t) {
      e.css("display", "none"), t && t()
    },
    ...
    scrollLoading: function(e) {
      ...
      a + n >= t - 30 && s < o && i.lock && (i.lock = !1, $.when(i.getUnreaded(!1)).done(function() {
        i.lock = !0
      }))
    },
    getUnreaded: function(e) {
      ...
      if (n.addClass("active"), i.show(), e && (a.scrollTop(0), a.html("")), t.$unreadNews.find(".fn-newsLoading").remove(), 0 == s && e) t.showNoDom();
        ...
        var o = $.Deferred();
        return t.initLock = !1, e ? t.$unreadNews.append("<p class='fn-newsLoading text-center text-muted'>正在获取未读消息列表，请稍后</p>") : t.$unreadNews.append("<p class='fn-newsLoading text-center text-muted'>加载中，请稍后</p>"), t.ajaxUnreadList && t.ajaxUnreadList.abort(), t.ajaxUnreadList = fnTool.ajaxSimply("get", {
          whatdo: "GetListOfUnreadMessageByUser",
          PageSize: t.size,
          PageIndex: t.start
        }, this.url, function(n) {
          if (t.$unreadNews.find(".fn-newsLoading").remove(), n.Succeed) {
            ...
            var i = n.length,
              c = "";
            if (!i) return void a.append("<p class='text text-muted'>暂时没有新数据</p>").children(".text-muted").animate({
              opacity: "0.8"
            }, 2e3, function() {
              $(this).remove(), t.showNoDom(), 0 !== s && t.changeNum(s, !1)
            });
    ...
    init: function() {
      ...
      setTimeout(function() {
        ...
        e.$noticeCon.is(":visible") && e.setConMaxHeight()
      }), $(document).bind("click", function() {
        e.resetState()
      }), e.$noticeCon.bind("click", function(t) {
        fnTool.stopPropagation(t), e.detailSwtich = !0
      }), e.judgeOpen(), $("body").delegate("#bdshare_s", "click", function(e) {
        fnTool.stopPropagation(e)
      }), this.$noticeTrigger.bind("click", function(a) {
        ...
        var a = $(this);
        if ("a" == a.children().eq(0).get(0).tagName.toLowerCase()) e.tagReaded(a, function() {
          e.$alertTxt.html(parseInt(e.$alertTxt.html()) - 1), e.$alertClose.before("<span class='text-warning fn-s-alertW'>已经标记为已读</span>"), clearInterval(e.alertTimer), e.alertTimer = setTimeout(function() {
            e.$alert.find(".fn-s-alertW").remove(), e.$alert.children("ul").children("li").length || e.closeAlert()
          }, 2e3)
        });
        else {
      ...
      }), this.$lists.bind("scroll", function() {
        e.scrollLoading(this)
      }), e.$lists.delegate(".fa-noticeList", "click", function() {
        ...
        e.tagReaded(a, function() {
          e.$lists.children("li").length || e.showNoDom(), e.setConMaxHeight()
        })
      }), this.$hasNews.delegate(".fn-tagReaded", "click", function(t) {
        fnTool.stopPropagation(t), e.tagReaded("all")
      }), this.$noticeDetail.find(".fa-closeDetail").bind("click", function() {
        ...
        var t = $(this).attr("data-dom");
        e.closeDataPage(e.$readedLists, function() {
          "true" === t ? e.detailSwtich ? (e.showHasDom(), e.showUnreadDom()) : (e.start = 1, e.getUnreaded(!0)) : e.showNoDom(), e.setConMaxHeight()
        })
      }), e.$alertClose.click(function() {
        e.closeAlert()
      })
    }
  };
window.document.onkeydown = NormalSearchNew, 
$(function() {
  setAdvHeight(), 
  ...
  e.init(), 
  setNavStyle(), 
  $(".fn-ss-dropdown").sDropdown({
    callback: function() {
      checkNotice(), 
      checkSearch()
    }
  }), 
  $("#searchDateRangePicker input").eq(0).bind("focus", function() {
    WdatePicker({
      maxDate: (new Date).Format("YYYY-MM-dd")
    })
  }), 
  $("#searchDateRangePicker input").eq(1).bind("focus", function() {
    WdatePicker({
      minDate: $(".fn-s-timeInput").eq(0).val()
    })
  }), 
  Notice.init(), 
  $("#fn-s-msTxt").bind("keydown", function(e) {
    var t = e || window.event;
    fnTool.stopPropagation(e), 13 == t.keyCode && AllMediaResults()
  }), 
  $("#fn-s-msBtn").bind("click", function() {
    AllMediaResults()
  }), 
  $("#fn-s-cm").delegate("li", "click", function() {
    AddMediaNew(this)
  }), 
  $("#fn-s-cCm").bind("click", function() {
    ClearMedia()
  }), 
  $(".fn-s-sdLists").bind("click", function() {
    ShowMediaBlock(".fn-mediablock")
  }), 
  $("#fn-s-cr").delegate(".fn-s-dCm", "click", function(e) {
    fnTool.stopPropagation(e), ReduceMediaNew(this)
  }), 
  $("#normalSearchKey").click(function(e) {
  ...
  $(".normal_search_option").click(function(e) {
    $("#search-top").addClass("GPLOIDFCK4C"), $(".normal_search_option").slideDown(100), fnTool.stopPropagation(e)
  }), 
  $(".fn-ss-btnS").bind("click", function() {
    NormalSearchClickNew()
  }), 
  $(document).click(function(e) {
    $("#search-top").removeClass("GPLOIDFCK4C"), 
    $("#normalSearchKey").removeClass("error")
    $(e.target).is(".normal_search_option") || 
      ($(".normal_search_option").slideUp(100), ToNormalSearch())
  }), 
  $("iframe").each(function() {
    var e = $(this);
    e.load(function() {
      e.contents().find("body").unbind("click").bind("click", function() {
        $("#search-top").removeClass("GPLOIDFCK4C"), 
        $("#normalSearchKey").removeClass("error"), 
        $(".normal_search_option").slideUp(100), 
        ToNormalSearch()
      })
    })
  }), 
  ...
  $("#fn-s-toNorSearch").click(function() {
    ToNormalSearch()
  }), 
  $("#fn-s-toAdvSearch").click(function() {
    ToAdvSearch()
  }), 
  $(".fn-z-week").click(function() {
    var e = new Date,
      t = e.getDaysAgo(7),
      a = e.getDaysAgo(0);
    $(".fn-s-timeInput:eq(0)").val(t), 
    $(".fn-s-timeInput:eq(1)").val(a)
  }), 
...
Search.prototype.resetState = function() {
  $(".fn-z-searchareacontent").hide(), $(".fn-z-searchprovince").show(), $(".fn-z-searchcity").show()
}, 
Search.prototype.addCity = function(e) {
