! function(e) {
  ...
  function t(e, a, t) { M.attr("src", ""), M.contents().find("body").html("<div style='text-align:center; margin-top: 10px;' class='fn-s-indexLoad'><img src='/v2/images/ajax-loader.gif'/></div>"), P.init(e, a), M.attr("src", "/WebPageEmbed.html?ArticleSequenceId=" + t + "&keypar=") }
  ...
  function i() {
    fnTool.ajaxSimply("get", { whatDo: "getImageNews" }, "/api/home.ashx", function(a) {
  ...
  function o(a, t) {
    ...
    fnTool.ajaxSimply("get", o, "/api/hotfind.ashx", function(a) {
      function t(a) {
    ...
    e.when(x.locateCurrentCityByIP()).done(function() {
      o.children(".fn-s-curPro").text(myProvince).end().children(".fn-s-curTown").text(myCity), e.when(x.getCityList()).done(function() {
        ...
        U = t[0].cid.replace("C", ""), r(U, n, s), e.when(x.getProvinceList()).done(function() {
          ...
          var a = e(this);
          a.hasClass("fn-s-backFirst") ? a.parent().hide().prev().show() : (n.css("background", 'url("/v2/images/ajax-loader.gif") no-repeat center 20px, #fff'), o.children(".fn-s-curPro").text(a.parent().data("province")).end().children(".fn-s-curTown").text(a.text()), U = a.attr("data-cid").replace("C", ""), r(U, n, s))
        })
      })
    })
  }
  ...
  function h(a, t) {
    function n(a) {
      fnTool.ajaxSimply("get", { whatDo: "getHotFindArticle", start: 0, limit: 6, markinfo: 0, startDate: a, endDate: a, rd: Math.random() }, "/api/hotfind.ashx", function(t) {
  ...
  var x = FNCommonService.createNew(),
    y = News.createNew(),
    w = "../Command/dataJson.html",
    T = "../Command/dataPost.html",
    k = "/api/ArticleList.ashx",
    C = "/api/clue.ashx?whatDo=mytrace",
  ...
  e(function() {
    e(".fn-ss-tab").sTab({ _class: "fn-s-active" }), i(), s(), l(), o(), d(), p(), h(), e("body").delegate(".fn-s-refresh", "click", function() {
      var a = e(this),
        t = a.parent().parent();
      t.find(".fn-s-bl").html("").css("background", "url('/v2/images/ajax-loader.gif') no-repeat center 20px, #fff"), a.hasClass("fn-s-reMedia") ? o("", t) : a.hasClass("fn-s-reLocal") ? d("", t) : a.hasClass("fn-s-reTrace") ? p("", t) : a.hasClass("fn-s-reHot") && h("", t)
