...
Lunbo.prototype = {
  ...
  // 导航
  let $nav0 = $('[href=#info]');
  let $nav01 = $('[href="#personage"]');
  let $nav1 = $('[href=#example]');
  let $nav2 = $('[href=#column0]');
  let $nav3 = $('[href=#column1]');
  let $nav4 = $('[href=#potential]');
  let $nav5 = $('[href=#honor]');
  let $nav6 = $('[href=#moments]');
  let $nav7 = $('[href=#leader]');
  let $nav8 = $('[href=#review]');
  let $nav9 = $('[href=#self]');
  let $nav10 = $('[href=#standard]');
  let $nav11 = $('[href=#company]');
  let $nav12 = $('[href=#contact]');
